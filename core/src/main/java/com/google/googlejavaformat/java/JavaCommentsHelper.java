...
public final class JavaCommentsHelper implements CommentsHelper {
  ...
  public String rewrite(Tok tok, int maxWidth, int column0) {
    ...
    if (tok.isSlashSlashComment()) {
      return indentLineComments(lines, column0, maxWidth);
    }
  ...
  private String indentLineComments(List<String> lines, int column0, int maxWidth) {
    lines = wrapLineComments(lines, column0, maxWidth);
    StringBuilder builder = new StringBuilder();
  ...
  private List<String> wrapLineComments(List<String> lines, int column0, int maxWidth) {
