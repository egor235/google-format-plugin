...
public final class StringWrapper {
  ...
  public static String wrap(String input, int maxLineLength, Formatter formatter) throws FormatterException {
    return StringWrapper.wrap(maxLineLength, input, formatter);
  }
