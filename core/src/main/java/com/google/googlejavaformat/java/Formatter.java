...
public final class Formatter {
  ...
  public String formatSource(String input) throws FormatterException {
    input = formatSource(input, ImmutableList.of(Range.closedOpen(0, input.length())));
    return ImportOrderer.reorderImports(input, options.style());
  }
  ...
  public String formatSourceAndFixImports(String input) throws FormatterException {
    ...
    formatted = StringWrapper.wrap(formatted, options.maxLineLength(), this);
    return formatted;
  }
